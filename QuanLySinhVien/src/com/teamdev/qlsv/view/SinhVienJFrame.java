...
import com.teamdev.qlsv.controller.SinhVienController;
...
public class SinhVienJFrame extends javax.swing.JFrame {
     ...
     */
    public SinhVienJFrame(SinhVien sinhVien, MyAction myAction) {
        initComponents();
        this.sinhVien = sinhVien;
        this.sinhVienService = new SinhVienServiceImpl();
        this.myAction = myAction;
        SinhVienController controller = new SinhVienController(btnSubmit, jtfMaSinhVien, jtfHoTen, jdcNgaySinh, jrdNam, jrdNu, jtfSoDienThoai, jtaDiaChi, jcbTinhTrang, jlbMsg);
    ...
    private void initComponents() {
        ...
        jtfMaSinhVien.setEditable(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jlbMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jtfMaSinhVien, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
    ...
    private SinhVien getDataFromFrame() {
        sinhVien.setMaSinhVien(Integer.parseInt(jtfMaSinhVien.getText()));
        sinhVien.setHoTen(jtfHoTen.getText());
        sinhVien.setNgaySinh(jdcNgaySinh.getDate());
        sinhVien.setGioiTinh(jrdNam.isSelected());
        sinhVien.setSoDienThoai(jtfSoDienThoai.getText());
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (jtfHoTen.getText().length() == 0 || jdcNgaySinh.getDate() == null || jtfSoDienThoai.getText().length() == 0
                || jtaDiaChi.getText().length() == 0) {
        ...
        if (jtfMaSinhVien.getText().equals("0")) {
                System.out.println("Handle insert new sinhvien");
                getDataFromFrame();
                sinhVienService.insert(sinhVien);
            }
            if (jtfMaSinhVien.getText().length() != 0 && !jtfMaSinhVien.getText().equals("0")) {
                System.out.println("Handle update new sinhvien");
                getDataFromFrame();
                sinhVienService.update(sinhVien);
            }

        if (myAction != null) {
            myAction.ReLoadTable(true);
        }
